...
7. [web-workers](https://github.com/nepaul/learn-web-development-by-codes/tree/master/vuejs-guide-demos): A basic WebWorkers usage from [MDN](https://developer.mozilla.org/en-US/docs/Web/API/Web_Workers_API/Using_web_workers).
